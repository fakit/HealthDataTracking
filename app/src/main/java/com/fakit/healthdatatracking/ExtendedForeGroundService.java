...
public class ExtendedForeGroundService extends Service {
    ...
    public ExtendedForeGroundService() {
    }
...
//        builder.setStyle(bigTextStyle);
       ...
       // builder.setLargeIcon(largeIconBitmap);
        ...
        Intent playIntent = new Intent(this, ExtendedForeGroundService.class);
        ...
        Intent pauseIntent = new Intent(this, ExtendedForeGroundService.class);
